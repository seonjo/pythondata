...
import re
custlist=[{'name': '홍길동', 'gender': 'M', 'email': 'hong1211@gmail.com', 'birth': '2000'},
          {'name': '김나리', 'gender': 'F', 'email': 'kim111@gmail.com', 'birth': '2000'},
          {'name': '박정희', 'gender': 'F', 'email': 'park111@gmail.com', 'birth': '2000'}]
# custlist = []          
page = len(custlist)-1
